...
import { allPosts, createPost, getPostById, updatePostById, deletePostById, likePost, unlikePost, addCommentToPost, getCommentsForPost, updateComment, deleteComment } from '../controllers/community.controller';
...
router
    ...
    .post(authMiddleware, validateCreatePost, asyncHandler(createPost));        // 게시글 작성하기
...
router
    .route('/:post_id/like')
    .post(authMiddleware, asyncHandler(likePost))           // 좋아요 추가
    .delete(authMiddleware, asyncHandler(unlikePost));      // 좋아요 취소
